 ...
 * @version 1.0
 */
public class PatternMatchingStudentTest1 {
    ...
    @Test(timeout = TIMEOUT)
    public void testFailureTableErrors() {
    ...
    @Test(timeout = TIMEOUT)
    public void testGalilMultipleMatches() {
        /*
            pattern: ab
            text: abab
            indices: 0, 2
    ...
    @Test(timeout = TIMEOUT)
    public void testGalilLongerText() {
        /*
            pattern: sea lions trains cardinal boardwalk
            text: sell
            indices: -
